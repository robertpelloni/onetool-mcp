...
| `[dev]` | `aws`, `chrome_devtools_util`, `context7`, `db`, `diagram`, `package`, `playwright_util`, `ripgrep`, `web`, `worktree` |
...
| [**Chrome DevTools Util**](chrome-devtools-util.md) | `[dev]` | Visual element annotation for the Chrome DevTools MCP server. | 5 | MIT | `clear_annotations`, `guide_user`, `highlight_element`, `inject_annotations`, `scan_annotations` |
